    ...
    <main className="h-screen">
      ...
      <section className="flex flex-row">
        <div className="mx-10">
          ...
          {/* Desc */}
          <p className="font-Poppins font-semibold mt-[10px]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora,
            ex.
          </p>
          <div className="flex space-x-9 mt-[50px]">
            <button className="bg-blue-600 px-8 py-2 mr-4 text-md rounded-lg text-white font-Poppins font-semibold border-gray-400 hover:bg-blue-800">
              Explore
            </button>
          ...
          <div className="flex mt-[80px] cursor-pointer hover:">
            ...
            <PlayIcon className="h-6 text-blue-600 ml-1 hover:transition duration-75 hover:rotate-45" />
          </div>
        </div>
      ...
      <section className="flex flex-col my-[40px] mx-10">
        <div className=" mx-auto ">
          <p className="text-3xl font-Nunito">Trending</p>
        </div>
        {/* Cards */}
      ...
      <div className="flex flex-col ">
        <div className=" mx-auto ">
          <p className="text-3xl font-Nunito">Collections</p>
        </div>

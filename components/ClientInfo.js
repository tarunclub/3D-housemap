  ...
  return (
    <div className="flex flex-col items-center py-8 space-y-4">
      ...
      <p className="text-white text-semibold text-md font-Ubuntu">
        ...
        nisi enim tenetur culpa exercitationem reprehenderit repellat. Fugit
        nemo consequuntur, ducimus, assumenda saepe enim quod odio voluptates
        maiores dolore id.
      </p>
      ...
      <div className="flex flex-col items-center mx-auto mt-28">
        ...
        <p className="font-Poppins font-bold text-xs text-gray-600">
          {session?.user.email}
        </p>
      </div>

                  ...
                  <Transition.Child
                    ...
                    <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                      ...
                      <div className="mt-2">
                        ...
                        <div className="flex">
                          <input type="number" name="" className="inp" id="" placeholder="width" />
                          <input type="number" name="" id="" className="inp" placeholder="length" />
                        </div>
                        <div>
                          <label htmlFor="direction" className="mr-4">
                            Directions
                          </label>
                          <select
                            id="direction"
                        ...
                        <div>
                          <input type="number" name="" id="" className="inp" placeholder="Floors" />
                        </div>
                      </div>
